...
def get_meal_url_for_date(meal_type, target_date):
    return f"https://www.mealtify.com/univ/pusan/gumjeong-staff/{target_date}/{meal_type}"
...
def main():
    ...
    for _ in range(5):
        ...
        for meal_type in meal_types:
            ...
            crawling_and_write_to_csv(meal_url, meal_type, csv_file_path, target_date, "금정회관-교직원")
